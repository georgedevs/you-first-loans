      ...
      <header className="bg-gradient-to-r from-blue-900 to-blue-800 text-white py-6 px-6 shadow-lg">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex flex-col items-center sm:items-end">
            <p className="text-blue-200 font-medium">Trusted Financial Solutions</p>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="space-y-4">
              ...
              <p className="text-gray-300">Providing accessible and transparent financial services for Nigerians. Our mission is to empower individuals and businesses through fair lending practices.</p>
              <div className="pt-4">
            ...
            <div className="mt-8 md:mt-0">
              <h3 className="text-lg font-semibold mb-6 text-blue-300">Our Office</h3>
              <p className="text-gray-300 mb-4">Plot 6, Abebi Close, Ojodu, Nigeria</p>
              <div className="space-y-4">
                <h4 className="text-blue-300 font-medium">Working Hours</h4>
