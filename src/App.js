...
>
  ...
  <line x1="8" y1="7" x2="16" y2="17" />
              ...
              <p className="text-gray-300">
                Providing accessible and transparent financial services for
                Nigerians. Our mission is to empower individuals and businesses
                through fair lending practices.
              </p>
              <div className="pt-4">
                <p className="text-blue-300 font-medium">Contact Us</p>
                <p className="text-gray-400 text-sm mt-2">
                  Email: info@youfirstloans.com
                </p>
                <p className="text-gray-400 text-sm">
                  Phone: +234 803 719 6159
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 md:mt-0">
              ...
              <p className="text-gray-300 mb-4">
                Plot 6, Abebi Close, Ojodu, Nigeria
              </p>
              <div className="space-y-4">
